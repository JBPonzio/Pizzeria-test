 ...
 */
class getIngredientPizzaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IngredientPizzaRepository' shared autowired service.
     *
     * @return \App\Repository\IngredientPizzaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IngredientPizzaRepository.php';

        return $container->privates['App\\Repository\\IngredientPizzaRepository'] = new \App\Repository\IngredientPizzaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
