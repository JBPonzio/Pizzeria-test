 ...
 */
class getIngredientRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IngredientRepository.php';

        return $container->privates['App\\Repository\\IngredientRepository'] = new \App\Repository\IngredientRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
