 ...
 */
class getPizzaioloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PizzaioloRepository' shared autowired service.
     *
     * @return \App\Repository\PizzaioloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PizzaioloRepository.php';

        return $container->privates['App\\Repository\\PizzaioloRepository'] = new \App\Repository\PizzaioloRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
