...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'PizzaFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'PizzaioloFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'PizzeriaFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\IngredientFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\PizzaFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\PizzaioloFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\PizzeriaFixtures(), 'groups' => []]]);
