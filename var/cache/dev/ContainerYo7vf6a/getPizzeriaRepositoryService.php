 ...
 */
class getPizzeriaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PizzeriaRepository' shared autowired service.
     *
     * @return \App\Repository\PizzeriaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PizzeriaRepository.php';

        return $container->privates['App\\Repository\\PizzeriaRepository'] = new \App\Repository\PizzeriaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
